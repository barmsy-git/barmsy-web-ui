      ...
      <form className="w-[500px] flex flex-col items-center space-y-5">
        ...
        <div className="flex flex-col w-full">
          <div className="flex justify-between">
            ...
            <span className="text-orange-500 text-xs cursor-pointer">Change?</span>
          </div>
          <div className="relative mx-auto w-full">
            ...
            <input
              ...
              value={formData.email}
              disabled
              className="w-full px-1 text-xs py-2 pl-10 border bg-gray-200 border-gray-300 rounded-full text-gray-500"
            />
          </div>
        </div>
        ...
        <div className="flex flex-col w-full">
          <div className="flex justify-between">
            ...
            <span className="text-orange-500 text-xs cursor-pointer text-right">Change?</span>
          </div>
          <div className="relative mx-auto w-full">
            ...
            <input
              ...
              value={formData.phoneNumber}
              disabled
              className="w-full px-1 py-2 pl-10 border text-xs bg-gray-200 border-gray-300 rounded-full text-gray-500"
            />
          </div>
        </div>
...
<div className="flex flex-col w-full">
  ...
  <div className="relative mx-auto w-full">
    ...
    <input
      ...
      required
      className={`w-full px-3 py-2 text-xs pl-10 border rounded-full ${

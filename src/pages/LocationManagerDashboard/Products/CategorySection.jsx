        ...
        <table className="w-full text-xs text-left text-gray-600">
          <thead className="bg-gray-50 border-b">
            <tr>
              ...
              <th className="p-3 text-center w-[20%]">Name</th>
              <th className="p-3 text-center w-[20%]">Product</th>
              <th className="p-3 text-center w-[15%]">Created</th>
              <th className="p-3 text-center w-[15%]">Status</th>
              <th className="p-3 text-center w-[15%]">Actions</th>
                  ...
                  <td colSpan="100%">
                    <div className="border border-dashed rounded-lg p-2">
                      <div className="flex items-center justify-between">
                        <button onClick={() => toggleRowExpand(location.id)} className="text-xs focus:outline-none w-[5%] flex justify-center">
                          {expandedRows.has(location.id) ? "▲" : "▼"}
                        </button>
                        ...
                        <span className="text-[10px] font-semibold w-[20%]">{location.Name}</span>
                        <span className="text-[10px] font-semibold w-[20%]">{location.Product}</span>
                        <span className="text-[10px] font-semibold w-[15%]">{location.created}</span>

                        <div className="w-[15%]">
                          <button className={`w-9 h-3 flex items-center rounded-full ${location.status ? "bg-orange-500" : "bg-gray-300"}`} onClick={() => toggleStatus(location.id)} />
                        </div>

                        <div className="flex space-x-3 w-[15%]">
                          <button><img src={edit} className="h-4 w-4" alt="Edit" /></button>
                          <button onClick={() => handleDeleteClick(location)}><img src={deleteButton} className="h-4 w-4" alt="Delete" /></button>
                        </div>
                      </div>

                      {expandedRows.has(location.id) && <div className="mt-2 p-2 border-t border-dashed">{location.subcategory}</div>}
                    </div>
                  </td>
                </tr>
              </React.Fragment>

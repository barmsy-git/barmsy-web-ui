...
const locations = [
  { id: 1, status: "Active", orders: 23, revenue: "₦100k", growth: "9.6%" },
  { id: 2, status: "Active", orders: 23, revenue: "₦100k", growth: "9.6%" },
  { id: 3, status: "Closed", orders: 23, revenue: "₦100k", growth: "9.6%" },
  { id: 4, status: "Active", orders: 23, revenue: "₦100k", growth: "9.6%" },
  { id: 4, status: "Active", orders: 23, revenue: "₦100k", growth: "9.6%" },
  { id: 4, status: "Active", orders: 23, revenue: "₦100k", growth: "9.6%" },
];
          ...
          {locations.map((loc) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-md font-bold text-black"> {loc.orders}<span className="text-[10px] font-thin text-gray-400">/menus</span></p>

                {/* Address */}
                <p className="text-xs text-black  font-bold mt-1">CITISTRRO</p>

                {/* Revenue & Growth - Side by Side */}
                <div className="flex justify-start space-x-5  mt-1">
                ...
                >
                  ...
                  <p className="text-xs font-semibold text-green-500 mt-2">↑ {loc.growth}</p>
                </div>
              </div>
            </div>
          ))}
